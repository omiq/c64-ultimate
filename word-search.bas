...
1070 IF TG$="LI" THEN PRINT CHR$(119);" ";:TG$="": RETURN
...
4080 IF K$="1" THEN GOSUB 5100
4090 IF K$="2" THEN GOSUB 5200
4100 IF K$="3" THEN GOSUB 5300
4110 IF K$="4" THEN GOSUB 5400
4120 IF K$="5" THEN GOSUB 5500
4130 IF K$="6" THEN GOSUB 5600
4200 POKE 55296 + (OY*40)+OX, 1: REM UNDO OLD POSITION
4210 POKE 55296 + (Y*40)+X, 0: REM HIGHLIGHT POSITION
4220 GOTO 4020
5100 GOSUB 6000
5110 REM
5190 RETURN
5200 GOSUB 6000: RETURN
5300 GOSUB 6000: RETURN
5400 GOSUB 6000: RETURN
5500 GOSUB 6000: RETURN
5600 GOSUB 6000: RETURN
