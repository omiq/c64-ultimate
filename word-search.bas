...
1020 REM ------------------------------------------------------------
1025 REM PRINT "*";TG$;"*"
1040 IF TG$="H1" THEN PRINT "{CLR}{RVON}{CYAN}";:TG$="": RETURN
1050 IF TG$="/H1" THEN PRINT "{RVOF}{WHITE}";CHR$(13);:TG$="": RETURN
1055 IF TG$="H2" THEN PRINT "{YELLOW}";:TG$="": RETURN
1060 IF TG$="/H2" THEN PRINT "{WHITE}";CHR$(13);:TG$="": RETURN
1065 IF TG$="BR" THEN PRINT "{13}";:TG$="": RETURN
