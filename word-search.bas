...
3210 IF LEN(ST$)<40 THEN ST$=ST$+CHR$(C)
3220 IF ST$="400 BAD REQUEST" THEN GOTO 10: REM TRY LOADING AGAIN
3240 PRINT CHR$(C);
3250 RETURN 
4000 REM INTERACTIVE PORTION
4001 CY = 2: CX = 14: REM AVOID WORD GRID AT 1,2 TO 10,11
4005 GOSUB 7000: PRINT CHR$(158);"USE W, A, S, D + RETURN";CHR$(5): CY=3
...
4100 IF K$=CHR$(13) THEN GOSUB 5100
4110 GOTO 4020
5100 GOSUB 6000
5110 REM
5190 RETURN
