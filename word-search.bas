...
4010 X=1: Y=2: REM PLAYER CURSOR POSITION
4020 POKE 55296 + (Y*40)+X, 0: K$=""
4030 GET K$: IF K$="" THEN GOTO 4030
4040 IF K$="W" AND Y>2 THEN Y=Y-1
4050 IF K$="S" AND Y<16 THEN Y=Y+1
4060 IF K$="A" AND X>1 THEN X=X-1
4070 IF K$="D" AND X<15 THEN X=X+1
4100 GOTO 4020
