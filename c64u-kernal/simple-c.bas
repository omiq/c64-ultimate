0 print chr$(147);chr$(5);chr$(14);"16:35"
10 if a=0 then a=1:print "loading c driver...":load "swiftdrvr",8,1 : rem not swiftc
...
50 rem hangup
55 rem print#5,"+++";:for w=1 to 500:next:print#5,"ath"+chr$(13);
60 for w=1 to 1000:next
70 rem dial
80 print#5,"atdt192.168.0.5:8080"+chr$(13);
100 for w=1 to 3000:next
110 print#5,"get / http/1.1"+crlf$;
120 print#5,"host: 192.168.0.5"+crlf$+crlf$;
